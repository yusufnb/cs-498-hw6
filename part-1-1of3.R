...
min(cv.lat.reg[["lambda"]])
cv.lat.reg[["cvm"]][which.min(cv.lat.reg[["lambda"]])]
...
cv.long.unreg[["cvm"]][which.min(cv.long.unreg[["lambda"]])]
...
min(cv.long.reg[["lambda"]])
cv.long.reg[["cvm"]][which.min(cv.long.reg[["lambda"]])]
