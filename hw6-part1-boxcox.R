...
plot(x=obs_lat, y=pred_lat, type="p", main="Predicted vs. Actual Latitude", xlab="Actual Latitude", ylab="Predicted Latitude")
...
plot(x=obs_long, y=pred_long, type="p", main="Predicted vs. Actual Latitude", xlab="Actual Longitude", ylab="Predicted Longitude")
...
boxcox_lat.lm<-lm(boxcox_y_lat~x_matrix)
boxcox_long <-data.frame(ind=x_matrix, dep=boxcox_y_long)
boxcox_long.lm<-lm(boxcox_y_long~x_matrix)
...
rsquared_boxcox_long <- var(reversed_boxcox_long)/var(y_long_matrix)
